...
class WildfirePage extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text('1. Seek Shelter', style: TextStyle(fontSize: 18)),
                  Text('2. Evacuate when needed', style: TextStyle(fontSize: 18)),
                  Text('3. Use emergency kits', style: TextStyle(fontSize: 18)),
                ],
              ),
            ),
            SizedBox(height: 20),
